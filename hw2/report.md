# Carlos-Buendia-第二次人工智能编程作业

## 1. 任务拆解与 AI 协作策略

我在编写代码前，将完整的考场管理系统任务拆解为四个层次，并按照"从简单到复杂"的顺序让 AI 逐步完成：

**步骤1：基础框架**
首先要求 AI 创建一个包含 `Student` 类和 `ExamSystem` 类的 Python 程序框架，仅实现数据加载功能。目的是验证 AI 是否理解面向对象编程的基本结构。

**步骤2：交互功能**
让 AI 为 ExamSystem 类添加三个用户交互功能：
- 按学号查找学生（功能1）
- 随机点名（功能2）
- 生成考场安排表（功能3）
...
以下是 AI 生成的 `generate_seat` 方法的核心逻辑代码，我已加上逐行中文注释：
